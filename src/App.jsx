...
// WhatsApp floating button. Extracted so it can call useLanguage() and read
// its aria-label from the UI-strings store while inside LanguageProvider.
  ...
  return (
    ...
    >
      ...
      <span className="wa-float-btn">
        <svg viewBox="0 0 32 32" fill="#fff" width="18" height="18" aria-hidden="true">
